...
function loadNextQuestion () {
    ...
    if(currentQuestion == totalQuestions) {
        ...
        result.innerHTML =
         `<h1 class="final-score">Your score: <br> ${totalScore}<br></h1>
         <div class="summary">
            <h1>Summary</h1>
            <p>Possible - The Perfect Drink For You Is:</p>
            <p>15 - 21- Old Fashioned- just like you</p>
            <p>10 - 15 - Martini- you stick to the classics, no shame in that </p>
            <p>5 - 10 - Strawberry Lemon Drop- You want to have fun and drink liquid sugar </p>
            <p>5 - Just stick to shots and beers dude</p>
        </div>
